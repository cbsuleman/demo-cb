...
import cruisebrains from '@/images/logo/CruiseBrains-logo-v3.png'
...
export function Logomark({
  ...
  return (
    <div className={` ${className} rounded-lg bg-neutral-950 p-2`}>
      <Image
        src={cruisebrains}
        width={60}
        height={60}
        quality={80}
        alt="CruiseBrains logo."
      />
    </div>
...
export function Logo({
  ...
  return (
    <div
      className={`${clsx(fillOnHover && 'group/logo', className)} rounded-lg bg-neutral-950 p-2`}
    >
      <Image
        src={cruisebrains}
        width={100}
